...
class ControllerCatalogAttribute extends Controller { 
	private $error = array();
  	...
  	public function index() {
		$this->load->idioma('catalog/attribute');
  	...
  	private function getList() {
		...
		$this->data['column_attribute_group'] = $this->idioma->get('column_attribute_group');
  	...
  	private function getForm() {
		...
		$this->data['entry_attribute_group'] = $this->idioma->get('entry_attribute_group');
	...
	private function validateForm() {
  	...
  	private function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $attribute_id) {
			$product_total = $this->model_catalog_evento->getTotalProductsByAttributeId($attribute_id);
