...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['logged'] = sprintf('Aangemeld als <span>%s</span>', $this->user->getUserName());
...
//			$this->data['import'] = $this->url->link('import/participantes', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['publicidad'] = $this->url->link('catalog/publicidad', 'token=' . $this->session->data['token'], 'SSL');
