...
class ControllerReportProductViewed extends Controller {
	public function index() {     
		$this->load->idioma('report/product_viewed');
		...
		$this->data['column_viewed'] = $this->idioma->get('column_viewed');
		$this->data['column_percent'] = $this->idioma->get('column_percent');
		
		$this->data['button_reset'] = $this->idioma->get('button_reset');
