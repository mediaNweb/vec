<?php
class ControllerReportSaleImpuesto extends Controller {
	public function index() {     
		$this->load->idioma('report/sale_impuesto');
		...
		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/sale_impuesto', 'token=' . $this->session->data['token'] . $url, 'SSL'),
      		'separator' => ' :: '
   		);		
		...
		$order_total = $this->model_report_sale->getTotalImpuestos($data); 
		
		$this->data['orders'] = array();
		
		$results = $this->model_report_sale->getImpuestos($data);
		...
		$pagination->url = $this->url->link('report/sale_impuesto', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->template = 'report/sale_impuesto.tpl';
		$this->children = array(
			'common/header',
			'common/footer',
		);
