...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->get['filter_cedula'])) {
				$url .= '&filter_cedula=' . $this->request->get['filter_cedula'];
			}
  	...
  	private function getList() {
		...
		if (isset($this->request->get['filter_cedula'])) {
			$filter_cedula = $this->request->get['filter_cedula'];
		} else {
			$filter_cedula = null;
		}
		...
		$this->data['column_cedula'] = $this->idioma->get('column_cedula');
		...
		$this->data['button_invoice'] = $this->idioma->get('button_invoice');
		...
		$this->data['sort_cliente'] = $this->url->link('sale/order', 'token=' . $this->session->data['token'] . '&sort=cliente' . $url, 'SSL');
		...
		$this->data['filter_cedula'] = $filter_cedula;
  	...
  	public function getForm() {
		...
		$this->data['entry_firstname'] = $this->idioma->get('entry_firstname');
		$this->data['entry_lastname'] = $this->idioma->get('entry_lastname');
		$this->data['entry_email'] = $this->idioma->get('entry_email');
		$this->data['entry_telephone'] = $this->idioma->get('entry_telephone');
		$this->data['entry_fax'] = $this->idioma->get('entry_fax');
		$this->data['entry_address'] = $this->idioma->get('entry_address');
		$this->data['entry_company'] = $this->idioma->get('entry_company');
		$this->data['entry_address_1'] = $this->idioma->get('entry_address_1');
		$this->data['entry_address_2'] = $this->idioma->get('entry_address_2');
		$this->data['entry_city'] = $this->idioma->get('entry_city');
		$this->data['entry_postcode'] = $this->idioma->get('entry_postcode');
		$this->data['entry_zone'] = $this->idioma->get('entry_zone');
		$this->data['entry_zone_code'] = $this->idioma->get('entry_zone_code');
		$this->data['entry_country'] = $this->idioma->get('entry_country');		
		$this->data['entry_product'] = $this->idioma->get('entry_product');
		$this->data['entry_model'] = $this->idioma->get('entry_model');
		$this->data['entry_quantity'] = $this->idioma->get('entry_quantity');
		$this->data['entry_price'] = $this->idioma->get('entry_price');
		...
		$this->data['entry_shipping'] = $this->idioma->get('entry_shipping');
		$this->data['entry_payment'] = $this->idioma->get('entry_payment');
		$this->data['entry_total'] = $this->idioma->get('entry_total');

		$this->data['button_save'] = 'Guardar';
		$this->data['button_cancel'] = 'Cancelar';
		$this->data['button_add_product'] = $this->idioma->get('button_add_product');
		$this->data['button_remove'] = 'Eliminar';

		$this->data['tab_order'] = $this->idioma->get('tab_order');
		$this->data['tab_product'] = $this->idioma->get('tab_product');
		$this->data['tab_payment'] = $this->idioma->get('tab_payment');
		$this->data['tab_shipping'] = $this->idioma->get('tab_shipping');
		$this->data['tab_total'] = $this->idioma->get('tab_total');
		...
		if (isset($this->request->post['cliente'])) {
			$this->data['cliente'] = $this->request->post['cliente'];
		} elseif (isset($order_info)) {
			$this->data['cliente'] = $order_info['cliente'];
		} else {
			$this->data['cliente'] = '';
		}
		...
		if (isset($this->request->post['customer_id'])) {
			$this->data['addresses'] = $this->model_sale_cliente->getAddresses($this->request->post['customer_id']);
		} elseif (isset($order_info)) {
			$this->data['addresses'] = $this->model_sale_cliente->getAddresses($order_info['customer_id']);
		} else {
    	...
    	if (isset($this->request->post['shipping_paises_id'])) {
      		$this->data['shipping_paises_id'] = $this->request->post['shipping_paises_id'];
    	} elseif (isset($order_info)) { 
			$this->data['shipping_paises_id'] = $order_info['shipping_paises_id'];
		} else {
      		$this->data['shipping_paises_id'] = '';
    	}		
    	...
    	if (isset($this->request->post['payment_paises_id'])) {
      		$this->data['payment_paises_id'] = $this->request->post['payment_paises_id'];
    	} elseif (isset($order_info)) { 
			$this->data['payment_paises_id'] = $order_info['payment_paises_id'];
		} else {
      		$this->data['payment_paises_id'] = '';
    	}		
		...
		foreach ($order_products as $order_product) {
			$product_info = $this->model_catalog_evento->getProduct($order_product['product_id']);
			...
			if ($product_info) {
				...
				$product_options = $this->model_catalog_evento->getProductOptions($order_product['product_id']);	
					...
					if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox') {
						...
						foreach ($product_option['product_option_value'] as $product_option_value) {
							$option_value_data[] = array(
								...
								'price'                   => (float)$product_option_value['price'] ? $this->moneda->format($product_option_value['price'], $this->config->get('config_currency')) : false,
				...
				$this->data['order_products'][] = array(
					...
					'impuesto'              => $order_product['impuesto']
				);
			}
		}
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->data['text_invoice_no'] = $this->idioma->get('text_invoice_no');
			$this->data['text_invoice_date'] = $this->idioma->get('text_invoice_date');
			$this->data['text_store_name'] = $this->idioma->get('text_store_name');
			$this->data['text_store_url'] = $this->idioma->get('text_store_url');		
			...
			$this->data['text_ip'] = $this->idioma->get('text_ip');
			$this->data['text_telephone'] = $this->idioma->get('text_telephone');
			$this->data['text_fax'] = $this->idioma->get('text_fax');
			$this->data['text_total'] = $this->idioma->get('text_total');
			$this->data['text_reward'] = $this->idioma->get('text_reward');		
			$this->data['text_order_status'] = $this->idioma->get('text_order_status');
			$this->data['text_comment'] = $this->idioma->get('text_comment');
			$this->data['text_affiliate'] = $this->idioma->get('text_affiliate');
			$this->data['text_commission'] = $this->idioma->get('text_commission');
			$this->data['text_date_added'] = $this->idioma->get('text_date_added');
			$this->data['text_date_modified'] = $this->idioma->get('text_date_modified');			
			$this->data['text_firstname'] = $this->idioma->get('text_firstname');
			$this->data['text_lastname'] = $this->idioma->get('text_lastname');
			$this->data['text_company'] = $this->idioma->get('text_company');
			$this->data['text_address_1'] = $this->idioma->get('text_address_1');
			$this->data['text_address_2'] = $this->idioma->get('text_address_2');
			$this->data['text_city'] = $this->idioma->get('text_city');
			$this->data['text_postcode'] = $this->idioma->get('text_postcode');
			$this->data['text_zone'] = $this->idioma->get('text_zone');
			$this->data['text_zone_code'] = $this->idioma->get('text_zone_code');
			$this->data['text_country'] = $this->idioma->get('text_country');
			$this->data['text_shipping_method'] = $this->idioma->get('text_shipping_method');
			$this->data['text_payment_method'] = $this->idioma->get('text_payment_method');	
			$this->data['text_payment_number'] = $this->idioma->get('text_payment_number');	
			$this->data['text_payment_date'] = $this->idioma->get('text_payment_date');	
			$this->data['text_download'] = $this->idioma->get('text_download');
			$this->data['text_wait'] = $this->idioma->get('text_wait');
			$this->data['text_reward_add'] = $this->idioma->get('text_reward_add');
			$this->data['text_reward_remove'] = $this->idioma->get('text_reward_remove');
			$this->data['text_commission_add'] = $this->idioma->get('text_commission_add');
			$this->data['text_commission_remove'] = $this->idioma->get('text_commission_remove');
			$this->data['text_credit_add'] = $this->idioma->get('text_credit_add');
			$this->data['text_credit_remove'] = $this->idioma->get('text_credit_remove');
			
			$this->data['column_product'] = $this->idioma->get('column_product');
			$this->data['column_model'] = $this->idioma->get('column_model');
			$this->data['column_quantity'] = $this->idioma->get('column_quantity');
			$this->data['column_price'] = $this->idioma->get('column_price');
			$this->data['column_total'] = $this->idioma->get('column_total');
			$this->data['column_download'] = $this->idioma->get('column_download');
			$this->data['column_filename'] = $this->idioma->get('column_filename');
			$this->data['column_remaining'] = $this->idioma->get('column_remaining');
			...
			$this->data['button_invoice'] = $this->idioma->get('button_invoice');
			$this->data['button_cancel'] = 'Cancelar';
			$this->data['button_add_history'] = $this->idioma->get('button_add_history');
		
			$this->data['tab_order'] = $this->idioma->get('tab_order');
			$this->data['tab_payment'] = $this->idioma->get('tab_payment');
			$this->data['tab_shipping'] = $this->idioma->get('tab_shipping');
			$this->data['tab_product'] = $this->idioma->get('tab_product');
			$this->data['tab_order_history'] = $this->idioma->get('tab_order_history');
			...
			if ($order_info['customer_id']) {
				$this->data['cliente'] = $this->url->link('sale/cliente/update', 'token=' . $this->session->data['token'] . '&customer_id=' . $order_info['customer_id'], 'SSL');
			} else {
				$this->data['cliente'] = '';
			}
...
/*
			...
			$cliente_group_info = $this->model_sale_cliente_group->getClienteGroup($order_info['cliente_group_id']);

			if ($cliente_group_info) {
				$this->data['cliente_group'] = $cliente_group_info['name'];
			} else {
				$this->data['cliente_group'] = '';
			}
*/
...
//			$this->data['shipping_method'] = $order_info['shipping_method'];
			...
			$this->data['payment_date'] = date('d/m/Y', strtotime($order_info['payment_date']));
			$this->data['total'] = $this->moneda->format($order_info['total'], $order_info['currency_code'], $order_info['currency_value']);
...
/*
			$this->data['credit_total'] = $this->model_sale_cliente->getTotalClienteTransactionsByOrderId($this->request->get['order_id']); 
						
			$this->data['reward_total'] = $this->model_sale_cliente->getTotalClienteRewardsByOrderId($this->request->get['order_id']);
			...
			$this->data['commission'] = $this->moneda->format($order_info['commission'], $order_info['currency_code'], $order_info['currency_value']);
...
*/
			...
			$order_status_info = $this->model_localidad_order_status->getOrderStatus($order_info['order_status_id']);
			...
			$this->data['date_modified'] = date('d/m/Y', strtotime($order_info['date_modified']));
...
*/
			...
			foreach ($products as $product) {
				...
				$options = $this->model_sale_order->getOrderOptions($this->request->get['order_id'], $product['order_product_id'], $product['product_id']);
...
*/
						if ($option['name'] == 'País') {
							...
							$codigo_pais = $option['value'];
							$nombre_pais = $this->model_localidad_pais->getPaisByCodigo($codigo_pais);
						...
						} else if ($option['name'] == 'Estado') {

							$codigo_estado = $option['value'];
							$nombre_estado = $this->model_localidad_estado->getEstadoByCodigo($codigo_estado);
  	...
  	private function validateForm() {
		...
		if ($country_info && $country_info['postcode_required'] && (strlen(utf8_decode($this->request->post['shipping_postcode'])) < 2) || (strlen(utf8_decode($this->request->post['shipping_postcode'])) > 10)) {
			$this->error['shipping_postcode'] = $this->idioma->get('error_postcode');
		}

    	if ($this->request->post['shipping_paises_id'] == '') {
      		$this->error['shipping_country'] = $this->idioma->get('error_country');
    	}
		
    	if ($this->request->post['shipping_zone_id'] == '') {
      		$this->error['shipping_zone'] = $this->idioma->get('error_zone');
    	}
		
    	if ((strlen(utf8_decode($this->request->post['payment_firstname'])) < 1) || (strlen(utf8_decode($this->request->post['payment_firstname'])) > 32)) {
      		$this->error['payment_firstname'] = $this->idioma->get('error_firstname');
    	}

    	if ((strlen(utf8_decode($this->request->post['payment_lastname'])) < 1) || (strlen(utf8_decode($this->request->post['payment_lastname'])) > 32)) {
      		$this->error['payment_lastname'] = $this->idioma->get('error_lastname');
    	}

    	if ((strlen(utf8_decode($this->request->post['payment_address_1'])) < 3) || (strlen(utf8_decode($this->request->post['payment_address_1'])) > 128)) {
      		$this->error['payment_address_1'] = $this->idioma->get('error_address_1');
    	}

    	if ((strlen(utf8_decode($this->request->post['payment_city'])) < 3) || (strlen(utf8_decode($this->request->post['payment_city'])) > 128)) {
      		$this->error['payment_city'] = $this->idioma->get('error_city');
    	}

		$country_info = $this->model_localidad_pais->getPais($this->request->post['payment_paises_id']);
		...
		if ($country_info && $country_info['postcode_required'] && (strlen(utf8_decode($this->request->post['payment_postcode'])) < 2) || (strlen(utf8_decode($this->request->post['payment_postcode'])) > 10)) {
			$this->error['payment_postcode'] = $this->idioma->get('error_postcode');
		}

    	if ($this->request->post['payment_paises_id'] == '') {
      		$this->error['payment_country'] = $this->idioma->get('error_country');
    	}
		
    	if ($this->request->post['payment_zone_id'] == '') {
      		$this->error['payment_zone'] = $this->idioma->get('error_zone');
    	}		
	...
	public function zone() {
		...
		$results = $this->model_localidad_zone->getZonesByPaisId($this->request->get['paises_id']);
	...
	public function history() {
		...
		$this->data['column_date_added'] = $this->idioma->get('column_date_added');
		$this->data['column_status'] = $this->idioma->get('column_status');
		$this->data['column_notify'] = $this->idioma->get('column_notify');
		$this->data['column_comment'] = $this->idioma->get('column_comment');
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['customer_id']) {
				...
				$this->model_sale_cliente->addReward($order_info['customer_id'], $this->idioma->get('text_order_id') . ' #' . $this->request->get['order_id'], $order_info['reward'], $this->request->get['order_id']);
				
				$json['success'] = $this->idioma->get('text_reward_added');
			}
		}
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['customer_id']) {
				...
				$this->model_sale_cliente->deleteReward($this->request->get['order_id']);
			}
			
			$json['success'] = $this->idioma->get('text_reward_removed');
		}
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['affiliate_id']) {
				...
				$this->model_sale_affiliate->addTransaction($order_info['affiliate_id'], $this->idioma->get('text_order_id') . ' #' . $this->request->get['order_id'], $order_info['commission'], $this->request->get['order_id']);
			}
			
			$json['success'] = $this->idioma->get('text_commission_added');
		}
	...
	public function removecommission() {
		...
		$json = array(); 
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			$json['success'] = $this->idioma->get('text_commission_removed');
		}
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['customer_id']) {
				...
				$this->model_sale_cliente->addTransaction($order_info['customer_id'], $this->idioma->get('text_order_id') . ' #' . $this->request->get['order_id'], $order_info['total'], $this->request->get['order_id']);
			}
			
			$json['success'] = $this->idioma->get('text_credit_added');
		}
		...
		$json = array();
     	...
     	if (!$this->user->hasPermission('modify', 'sale/order')) {
			...
			if ($order_info && $order_info['customer_id']) {
				...
				$this->model_sale_cliente->deleteTransaction($this->request->get['order_id']);
			}
			
			$json['success'] = $this->idioma->get('text_credit_removed');
		}
	...
	public function download() {
  	...
  	public function invoice() {
		...
		$this->data['title'] = $this->idioma->get('heading_title');
		...
		$this->data['language'] = $this->idioma->get('code');

		$this->data['text_invoice'] = $this->idioma->get('text_invoice');
		...
		$this->data['text_telephone'] = $this->idioma->get('text_telephone');
		$this->data['text_fax'] = $this->idioma->get('text_fax');
		$this->data['text_to'] = $this->idioma->get('text_to');
		$this->data['text_ship_to'] = $this->idioma->get('text_ship_to');
