...
class ControllerSaleVoucherTheme extends Controller { 
	private $error = array();
  	...
  	public function index() {
		$this->load->idioma('sale/voucher_theme');
  	...
  	private function getForm() {
		...
		$this->data['entry_image'] = 'Im&aacute;gen:';
	...
	private function validateForm() {
		...
		if (!$this->request->post['image']) {
			$this->error['image'] = $this->idioma->get('error_image');
		}
  	...
  	private function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $voucher_theme_id) {
			...
			if ($voucher_total) {
	  			$this->error['warning'] = sprintf($this->idioma->get('error_voucher'), $voucher_total);	
			}  
	  	}
