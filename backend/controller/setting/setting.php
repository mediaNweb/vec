...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		$this->load->idioma('setting/setting'); 
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if ($this->config->get('config_currency_auto')) {
				$this->load->model('localidad/moneda');
		
				$this->model_localidad_moneda->updateMonedas();
			}	
		...
		$this->data['text_image_manager'] = $this->idioma->get('text_image_manager');
		$this->data['text_mail'] = $this->idioma->get('text_mail');
		$this->data['text_smtp'] = $this->idioma->get('text_smtp');
		
		$this->data['entry_name'] = $this->idioma->get('entry_name');
		$this->data['entry_owner'] = $this->idioma->get('entry_owner');
		...
		$this->data['entry_meta_description'] = $this->idioma->get('entry_meta_description');
		$this->data['entry_layout'] = $this->idioma->get('entry_layout');
		$this->data['entry_template'] = $this->idioma->get('entry_template');
		$this->data['entry_country'] = $this->idioma->get('entry_country');
		$this->data['entry_zone'] = $this->idioma->get('entry_zone');		
		$this->data['entry_language'] = $this->idioma->get('entry_language');
		$this->data['entry_admin_language'] = $this->idioma->get('entry_admin_language');
		$this->data['entry_currency'] = $this->idioma->get('entry_currency');
		$this->data['entry_currency_auto'] = $this->idioma->get('entry_currency_auto');
		$this->data['entry_length_class'] = $this->idioma->get('entry_length_class');
		$this->data['entry_weight_class'] = $this->idioma->get('entry_weight_class');
		$this->data['entry_catalog_limit'] = $this->idioma->get('entry_catalog_limit');
		$this->data['entry_admin_limit'] = $this->idioma->get('entry_admin_limit');
		$this->data['entry_impuesto'] = $this->idioma->get('entry_impuesto');
		$this->data['entry_invoice_prefix'] = $this->idioma->get('entry_invoice_prefix');
		$this->data['entry_cliente_group'] = $this->idioma->get('entry_cliente_group');
		$this->data['entry_cliente_price'] = $this->idioma->get('entry_cliente_price');
		$this->data['entry_cliente_approval'] = $this->idioma->get('entry_cliente_approval');
		$this->data['entry_guest_checkout'] = $this->idioma->get('entry_guest_checkout');
		$this->data['entry_account'] = $this->idioma->get('entry_account');
		$this->data['entry_checkout'] = $this->idioma->get('entry_checkout');
		$this->data['entry_affiliate'] = $this->idioma->get('entry_affiliate');	
		$this->data['entry_commission'] = $this->idioma->get('entry_commission');	
		$this->data['entry_stock_display'] = $this->idioma->get('entry_stock_display');
		$this->data['entry_stock_warning'] = $this->idioma->get('entry_stock_warning');
		$this->data['entry_stock_checkout'] = $this->idioma->get('entry_stock_checkout');
		$this->data['entry_order_status'] = $this->idioma->get('entry_order_status');
		$this->data['entry_complete_status'] = $this->idioma->get('entry_complete_status');	
		$this->data['entry_return_status'] = $this->idioma->get('entry_return_status');
		$this->data['entry_stock_status'] = $this->idioma->get('entry_stock_status');
		$this->data['entry_review'] = $this->idioma->get('entry_review');
		$this->data['entry_download'] = $this->idioma->get('entry_download');
		$this->data['entry_upload_allowed'] = $this->idioma->get('entry_upload_allowed');
		$this->data['entry_cart_weight'] = $this->idioma->get('entry_cart_weight');
		$this->data['entry_logo'] = $this->idioma->get('entry_logo');
		$this->data['entry_icon'] = $this->idioma->get('entry_icon');
		$this->data['entry_image_thumb'] = $this->idioma->get('entry_image_thumb');
		$this->data['entry_image_popup'] = $this->idioma->get('entry_image_popup');
		$this->data['entry_image_product'] = $this->idioma->get('entry_image_product');
		$this->data['entry_image_category'] = $this->idioma->get('entry_image_category');
		$this->data['entry_image_manufacturer'] = $this->idioma->get('entry_image_manufacturer');
		$this->data['entry_image_additional'] = $this->idioma->get('entry_image_additional');
		$this->data['entry_image_related'] = $this->idioma->get('entry_image_related');
		$this->data['entry_image_compare'] = $this->idioma->get('entry_image_compare');
		$this->data['entry_image_wishlist'] = $this->idioma->get('entry_image_wishlist');
		$this->data['entry_image_cart'] = $this->idioma->get('entry_image_cart');		
		$this->data['entry_mail_protocol'] = $this->idioma->get('entry_mail_protocol');
		$this->data['entry_mail_parameter'] = $this->idioma->get('entry_mail_parameter');
		$this->data['entry_smtp_host'] = $this->idioma->get('entry_smtp_host');
		$this->data['entry_smtp_username'] = $this->idioma->get('entry_smtp_username');
		$this->data['entry_smtp_password'] = $this->idioma->get('entry_smtp_password');
		$this->data['entry_smtp_port'] = $this->idioma->get('entry_smtp_port');
		$this->data['entry_smtp_timeout'] = $this->idioma->get('entry_smtp_timeout');
		$this->data['entry_alert_mail'] = $this->idioma->get('entry_alert_mail');
		$this->data['entry_account_mail'] = $this->idioma->get('entry_account_mail');
		$this->data['entry_alert_emails'] = $this->idioma->get('entry_alert_emails');
		$this->data['entry_use_ssl'] = $this->idioma->get('entry_use_ssl');
		$this->data['entry_maintenance'] = $this->idioma->get('entry_maintenance');
		$this->data['entry_encryption'] = $this->idioma->get('entry_encryption');
		$this->data['entry_seo_url'] = $this->idioma->get('entry_seo_url');
		$this->data['entry_compression'] = $this->idioma->get('entry_compression');
		$this->data['entry_error_display'] = $this->idioma->get('entry_error_display');
		$this->data['entry_error_log'] = $this->idioma->get('entry_error_log');
		$this->data['entry_error_filename'] = $this->idioma->get('entry_error_filename');
		$this->data['entry_google_analytics'] = $this->idioma->get('entry_google_analytics');
		
		$this->data['button_save'] = 'Guardar';
		$this->data['button_cancel'] = 'Cancelar';

		$this->data['tab_general'] = 'General';
		$this->data['tab_store'] = $this->idioma->get('tab_store');
		$this->data['tab_local'] = $this->idioma->get('tab_local');
		$this->data['tab_option'] = 'Opciones';
		$this->data['tab_image'] = 'Im&aacute;gen';
		$this->data['tab_mail'] = $this->idioma->get('tab_mail');
		$this->data['tab_server'] = $this->idioma->get('tab_server');
...
*/
		if (isset($this->request->post['config_paises_id'])) {
			$this->data['config_paises_id'] = $this->request->post['config_paises_id'];
		} else {
			$this->data['config_paises_id'] = $this->config->get('config_paises_id');
		}
		...
		$this->data['languages'] = $this->model_localidad_idioma->getIdiomas();
		...
		$this->data['currencies'] = $this->model_localidad_moneda->getMonedas();
...
/*
		...
		$this->load->model('localidad/length_class');
		
		$this->data['length_classes'] = $this->model_localidad_length_class->getLengthClasses();
		...
		$this->load->model('localidad/weight_class');
		
		$this->data['weight_classes'] = $this->model_localidad_weight_class->getWeightClasses();
*/						
		...
		if (isset($this->request->post['config_impuesto'])) {
			$this->data['config_impuesto'] = $this->request->post['config_impuesto'];
		} else {
			$this->data['config_impuesto'] = $this->config->get('config_impuesto');			
		}
...
/*
		...
		if (isset($this->request->post['config_cliente_group_id'])) {
			$this->data['config_cliente_group_id'] = $this->request->post['config_cliente_group_id'];
		} else {
			$this->data['config_cliente_group_id'] = $this->config->get('config_cliente_group_id');			
		}

		if (isset($this->request->post['config_cliente_price'])) {
			$this->data['config_cliente_price'] = $this->request->post['config_cliente_price'];
		} else {
			$this->data['config_cliente_price'] = $this->config->get('config_cliente_price');			
		}
		
		if (isset($this->request->post['config_cliente_approval'])) {
			$this->data['config_cliente_approval'] = $this->request->post['config_cliente_approval'];
		} else {
			$this->data['config_cliente_approval'] = $this->config->get('config_cliente_approval');			
		}
*/		
...
/*
		...
		$this->load->model('localidad/stock_status');
		
		$this->data['stock_statuses'] = $this->model_localidad_stock_status->getStockStatuses();
*/
...
/*
		...
		$this->load->model('localidad/return_status');
		
		$this->data['return_statuses'] = $this->model_localidad_return_status->getReturnStatuses();	
...
*/		
	...
	private function validate() {
		...
		if (!$this->request->post['config_image_cart_width'] || !$this->request->post['config_image_cart_height']) {
			$this->error['image_cart'] = $this->idioma->get('error_image_cart');
		}
		
		if (!$this->request->post['config_error_filename']) {
			$this->error['error_filename'] = $this->idioma->get('error_error_filename');
		}
