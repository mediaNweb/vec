...
class ControllerSettingStore extends Controller {
	...
	public function index() {
		$this->load->idioma('setting/store');
	...
	private function getList() {
		...
		$this->data['stores'][] = array(
			'store_id' => 0,
			'name'     => $this->config->get('config_name') . ' <b>(Predeterminado)</b>',
			'url'      => HTTP_CATALOG,
		...
		$this->data['column_url'] = $this->idioma->get('column_url');
	...
	public function getForm() { 
		...
		$this->data['entry_url'] = $this->idioma->get('entry_url');
		$this->data['entry_ssl'] = $this->idioma->get('entry_ssl');	
		...
		$this->data['entry_ajax_cart'] = $this->idioma->get('entry_ajax_cart');
		...
		} elseif (isset($store_info['config_paises_id'])) {
			$this->data['config_paises_id'] = $store_info['config_paises_id'];		
		} else {
		...
		$this->data['currencies'] = $this->model_localidad_moneda->getCurrencies();
		...
		} elseif (isset($store_info['config_impuesto'])) {
			$this->data['config_impuesto'] = $store_info['config_impuesto'];			
		} else {
			$this->data['config_impuesto'] = '';
		}
		...
		} elseif (isset($store_info['config_cliente_group_id'])) {
			$this->data['config_cliente_group_id'] = $store_info['config_cliente_group_id'];			
		} else {
			$this->data['config_cliente_group_id'] = '';
		}
		
		if (isset($this->request->post['config_cliente_price'])) {
			$this->data['config_cliente_price'] = $this->request->post['config_cliente_price'];
		} elseif (isset($store_info['config_cliente_price'])) {
			$this->data['config_cliente_price'] = $store_info['config_cliente_price'];			
		} else {
			$this->data['config_cliente_price'] = '';
		}
		...
		} elseif (isset($store_info['config_cliente_approval'])) {
			$this->data['config_cliente_approval'] = $store_info['config_cliente_approval'];			
		} else {
			$this->data['config_cliente_approval'] = '';
		}
	...
	private function validateForm() {
		...
		if (!$this->request->post['config_url']) {
			$this->error['url'] = $this->idioma->get('error_url');
		}
		...
		if (!$this->request->post['config_image_thumb_width'] || !$this->request->post['config_image_thumb_height']) {
			$this->error['image_thumb'] = $this->idioma->get('error_image_thumb');
		}	
		
		if (!$this->request->post['config_image_popup_width'] || !$this->request->post['config_image_popup_height']) {
			$this->error['image_popup'] = $this->idioma->get('error_image_popup');
		}
			
		if (!$this->request->post['config_image_product_width'] || !$this->request->post['config_image_product_height']) {
			$this->error['image_product'] = $this->idioma->get('error_image_product');
		}
				
		if (!$this->request->post['config_image_category_width'] || !$this->request->post['config_image_category_height']) {
			$this->error['image_category'] = $this->idioma->get('error_image_category');
		}
		
		if (!$this->request->post['config_image_manufacturer_width'] || !$this->request->post['config_image_manufacturer_height']) {
			$this->error['image_manufacturer'] = $this->idioma->get('error_image_manufacturer');
		}
		
		if (!$this->request->post['config_image_additional_width'] || !$this->request->post['config_image_additional_height']) {
			$this->error['image_additional'] = $this->idioma->get('error_image_additional');
		}
		
		if (!$this->request->post['config_image_related_width'] || !$this->request->post['config_image_related_height']) {
			$this->error['image_related'] = $this->idioma->get('error_image_related');
		}
		
		if (!$this->request->post['config_image_compare_width'] || !$this->request->post['config_image_compare_height']) {
			$this->error['image_compare'] = $this->idioma->get('error_image_compare');
		}
		
		if (!$this->request->post['config_image_wishlist_width'] || !$this->request->post['config_image_wishlist_height']) {
			$this->error['image_wishlist'] = $this->idioma->get('error_image_wishlist');
		}
		...
		if (!$this->request->post['config_catalog_limit']) {
			$this->error['catalog_limit'] = $this->idioma->get('error_limit');
		}
