      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td class="center"><img src="<?php echo $evento['layout/template/catalog/eventos_logo']; ?>" alt="<?php echo $evento['eventos_titulo']; ?>" style="padding: 1px; border: 1px solid #DDDDDD;" /></td>
...
function filter() {
	url = 'index.php?route=catalog/transcripcion&token=<?php echo $token; ?>';
