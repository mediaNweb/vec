...
<script type="text/javascript" src="layout/javascript/jquery/jquery-1.6.1.min.js"></script>
...
<script type="text/javascript" src="layout/javascript/jquery/jstree/jquery.tree.min.js"></script>
<script type="text/javascript" src="layout/javascript/jquery/ajaxupload.js"></script>
<style type="text/css">
body {
	padding: 0;
	margin: 0;
...
$(document).ready(function () { 
	...
	new AjaxUpload('#upload', {
		...
		onSubmit: function(file, extension) {
			$('#upload').append('<img src="layout/image/loading.gif" id="loading" style="padding-left: 5px;" />');
		},
