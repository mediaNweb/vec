      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
          <tr>
            ...
            <td><input type="text" name="estados_nombre" value="<?php echo $estados_nombre; ?>" />
              <?php if ($error_name) { ?>
          ...
          <tr>
            ...
            <td><input type="text" name="estados_codigo" value="<?php echo $estados_codigo; ?>" /></td>
          </tr>
          <tr>
            <td><?php echo $entry_country; ?></td>
            <td><select name="paises_id">
                <?php foreach ($paises as $pais) { ?>
                <?php if ($pais['paises_id'] == $paises_id) { ?>
                <option value="<?php echo $pais['paises_id']; ?>" selected="selected"><?php echo $pais['paises_nombre']; ?></option>
                <?php } else { ?>
          ...
          <tr>
            ...
            <td><select name="estados_status">
                <?php if ($estados_status) { ?>
