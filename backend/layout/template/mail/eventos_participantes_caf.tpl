...
<body>
<div id="container"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="http://assets.hipereventos.com/logo_caf.png" alt="<?php echo $store_name; ?>" id="logo" /></a> <br />
	<br />
	...
	<p>Para mayor información escríbenos a <a href="mailto:preguntasmaraton@caf.com">preguntasmaraton@caf.com</a></p>
</div>
</body>
</html>
