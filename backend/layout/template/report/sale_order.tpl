...
<div id="content">
  <div class="breadcrumb">
    ...
    <?php echo $breadcrumb['separator']; ?><a href="<?php echo $breadcrumb['layout/template/report/href']; ?>"><?php echo $breadcrumb['text']; ?></a>
    <?php } ?>
  </div>
  <div class="box">
    <div class="heading">
      <h1><img src="layout/template/report/layout/image/report.png" alt="" /> <?php echo $heading_title; ?></h1>
    </div>
    <div class="content">
      <table class="filter">
        <tr>
      ...
      <table class="list">
        <thead>
          <tr>
            ...
            <td class="right"><?php echo $column_impuesto; ?></td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="right"><?php echo $order['impuesto']; ?></td>
