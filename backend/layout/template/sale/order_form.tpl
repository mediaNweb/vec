      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-order" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" name="cliente" value="<?php echo $cliente; ?>" />
                <input type="hidden" name="cliente_id" value="<?php echo $cliente_id; ?>" /></td>
            </tr>
            <tr>
        ...
        <div id="tab-payment" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="payment_paises_id" onchange="$('select[name=\'payment_zone_id\']').load('index.php?route=sale/cliente/zone&token=<?php echo $token; ?>&paises_id=' + this.value + '&zone_id=<?php echo $payment_zone_id; ?>');">
                  <option value="false"><?php echo $text_select; ?></option>
                  <?php foreach ($paises as $country) { ?>
                  <?php if ($country['paises_id'] == $payment_paises_id) { ?>
                  <option value="<?php echo $country['paises_id']; ?>" selected="selected"><?php echo $country['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $country['paises_id']; ?>"><?php echo $country['name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select>
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_country; ?></td>
              <td><select name="shipping_paises_id" onchange="$('select[name=\'shipping_zone_id\']').load('index.php?route=sale/cliente/zone&token=<?php echo $token; ?>&paises_id=' + this.value + '&zone_id=<?php echo $shipping_zone_id; ?>');">
                  <option value="false"><?php echo $text_select; ?></option>
                  <?php foreach ($paises as $country) { ?>
                  <?php if ($country['paises_id'] == $shipping_paises_id) { ?>
                  <option value="<?php echo $country['paises_id']; ?>" selected="selected"><?php echo $country['name']; ?></option>
                  <?php } else { ?>
                  <option value="<?php echo $country['paises_id']; ?>"><?php echo $country['name']; ?></option>
                  <?php } ?>
...
$('input[name=\'cliente\']').catcomplete({
	delay: 0,
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=sale/cliente/autocomplete&token=<?php echo $token; ?>',
			type: 'POST',
			dataType: 'json',
			...
			success: function(data) {	
				response($.map(data, function(item) {
					return {
						category: item.cliente_group,
						label: item.name,
						value: item.cliente_id,
						cliente_group_id: item.cliente_group_id,
	...
	select: function(event, ui) { 
		$('input[name=\'cliente\']').attr('value', ui.item.label);
		$('input[name=\'cliente_id\']').attr('value', ui.item.value);
...
$('select[name=\'shipping_address\']').bind('change', function() {
	$.ajax({
		url: 'index.php?route=sale/cliente/address&token=<?php echo $token; ?>',
		type: 'POST',
		dataType: 'json',
		...
		success: function(data) {
			if (data) {	
				...
				$('select[name=\'shipping_paises_id\']').attr('value', data.paises_id);
				$('select[name=\'shipping_zone_id\']').load('index.php?route=sale/order/zone&token=<?php echo $token; ?>&paises_id=' + data.paises_id + '&zone_id=' + data.zone_id);
			}
		}
	});	
});
	...
	$.ajax({
		...
		success: function(data) {
			if (data) {	
				...
				$('select[name=\'payment_paises_id\']').attr('value', data.paises_id);
				$('select[name=\'payment_zone_id\']').load('index.php?route=sale/order/zone&token=<?php echo $token; ?>&paises_id=' + data.paises_id + '&zone_id=' + data.zone_id);
			}
		}
	});	
});

$('select[name=\'shipping_zone_id\']').load('index.php?route=sale/order/zone&token=<?php echo $token; ?>&paises_id=<?php echo $shipping_paises_id; ?>&zone_id=<?php echo $shipping_zone_id; ?>');
$('select[name=\'payment_zone_id\']').load('index.php?route=sale/order/zone&token=<?php echo $token; ?>&paises_id=<?php echo $payment_paises_id; ?>&zone_id=<?php echo $payment_zone_id; ?>');
//--></script> 
<script type="text/javascript"><!--
