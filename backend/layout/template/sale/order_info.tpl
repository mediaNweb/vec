...
-->
      ...
      <div id="tab-order" class="vtabs-content">
        <table class="form">
          ...
          <?php if ($cliente) { ?>
          <tr>
            <td><?php echo $text_cliente; ?></td>
            <td><a href="<?php echo $cliente; ?>"><?php echo $firstname; ?> <?php echo $lastname; ?></a></td>
          </tr>
          <?php } else { ?>
          <tr>
            <td><?php echo $text_cliente; ?></td>
          ...
          <?php } ?>
<!--
          <?php if ($cliente_group) { ?>
          <tr>
            <td><?php echo $text_cliente_group; ?></td>
            <td><?php echo $cliente_group; ?></td>
          </tr>
          <?php } ?>
-->		  
          <tr>
          ...
          <tr>
            ...
            <td><?php echo $total; ?>
              <?php if ($credit && $cliente) { ?>
              <?php if (!$credit_total) { ?>
              <img src="layout/template/sale/layout/image/add.png" alt="<?php echo $text_credit_add; ?>" title="<?php echo $text_credit_add; ?>" id="credit_add" class="icon" />
              <?php } else { ?>
              <img src="layout/template/sale/layout/image/delete.png" alt="<?php echo $text_credit_remove; ?>" title="<?php echo $text_credit_remove; ?>" id="credit_remove" class="icon" />
              <?php } ?>
              <?php } ?></td>
          </tr>
          <?php if ($reward && $cliente) { ?>
          <tr>
            <td><?php echo $text_reward; ?></td>
            <td><?php echo $reward; ?>
              <?php if (!$reward_total) { ?>
              <img src="layout/template/sale/layout/image/add.png" alt="<?php echo $text_reward_add; ?>" title="<?php echo $text_reward_add; ?>" id="reward_add" class="icon" />
              <?php } else { ?>
              <img src="layout/template/sale/layout/image/delete.png" alt="<?php echo $text_reward_remove; ?>" title="<?php echo $text_reward_remove; ?>" id="reward_remove" class="icon" />
              <?php } ?></td>
          </tr>
          <?php } ?>
          <?php if ($order_status) { ?>
...
<!--
          ...
          <tr>
            ...
            <td><?php echo $commission; ?>
              ...
              <img src="layout/image/add.png" alt="<?php echo $text_commission_add; ?>" title="<?php echo $text_commission_add; ?>" id="commission_add" class="icon" />
              <?php } else { ?>
              <img src="layout/image/delete.png" alt="<?php echo $text_commission_remove; ?>" title="<?php echo $text_commission_remove; ?>" id="commission_remove" class="icon" />
              <?php } ?></td>
          </tr>
          <?php } ?>
-->
      ...
      <div id="tab-payment" class="vtabs-content">
        <table class="form">
          ...
          <tr>
            <td><?php echo $text_payment_number; ?></td>
          ...
          <tbody id="product-row<?php echo $product['order_product_id']; ?>">
            <tr>
              <td class="left"><?php if ($product['product_id']) { ?>
                <a href="<?php echo $product['layout/template/sale/href']; ?>"><?php echo $product['name']; ?></a>
                <?php } else { ?>
                ...
                <?php } else { ?>
                &nbsp;<small> - <?php echo $option['name']; ?>: <a href="<?php echo $option['layout/template/sale/href']; ?>"><?php echo $option['value']; ?></a></small>
                <?php } ?>
                <?php } ?></td>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json.success) {
				...
				$('#reward_add').replaceWith('<img src="layout/image/delete.png" alt="<?php echo $text_reward_remove; ?>" id="reward_remove" class="icon" />');
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json.success) {
				...
				$('#reward_remove').replaceWith('<img src="layout/image/add.png" alt="<?php echo $text_reward_add; ?>" id="reward_add" class="icon" />');
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json.success) {
				...
				$('#commission_add').replaceWith('<img src="layout/image/delete.png" alt="<?php echo $text_commission_remove; ?>" id="commission_remove" class="icon" />');
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json.success) {
				...
				$('#commission_remove').replaceWith('<img src="layout/image/add.png" alt="<?php echo $text_commission_add; ?>" id="commission_add" class="icon" />');
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json.success) {
				...
				$('#credit_add').replaceWith('<img src="layout/image/delete.png" alt="<?php echo $text_credit_remove; ?>" id="credit_remove" class="icon" />');
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json.success) {
				...
				$('#credit_remove').replaceWith('<img src="layout/image/add.png" alt="<?php echo $text_credit_add; ?>" id="credit_add" class="icon" />');
...
function history() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#history').prepend('<div class="attention"><img src="layout/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
