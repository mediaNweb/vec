        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="right"><?php if ($sort == 'o.order_id') { ?>
                ...
                <?php } ?></td>
              <td class="left"><?php if ($sort == 'c.cedula') { ?>
                <a href="<?php echo $sort_cedula; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_cedula; ?></a>
                <?php } else { ?>
                <a href="<?php echo $sort_cedula; ?>"><?php echo $column_cedula; ?></a>
                <?php } ?></td>
          ...
          <tbody>
            <tr class="filter">
              ...
              <td><input type="text" name="filter_cedula" value="<?php echo $filter_cedula; ?>" /></td>
              <td><input type="text" name="filter_cliente" value="<?php echo $filter_cliente; ?>" /></td>
            ...
            <tr>
              ...
              <td class="left"><?php echo $order['cedula']; ?></td>
...
function filter() {
	...
	var filter_cedula = $('input[name=\'filter_cedula\']').attr('value');
	
	if (filter_cedula) {
		url += '&filter_cedula=' + encodeURIComponent(filter_cedula);
	}
