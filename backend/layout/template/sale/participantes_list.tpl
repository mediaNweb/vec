        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <td class="left"><?php if ($sort == 'e.eventos_titulo') { ?>
                ...
                <?php } ?></td>
              <td class="right"><?php echo $column_totales; ?></td>
              <td class="right"><?php echo $column_confirmados; ?></td>
              <td class="right"><?php echo $column_no_confirmados; ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="right"><?php echo $evento['totales']; ?></td>
              <td class="right"><?php echo $evento['confirmados']; ?></td>
              <td class="right"><?php echo $evento['no_confirmados']; ?></td>
...
function filter() {
	url = 'index.php?route=sale/participantes&token=<?php echo $token; ?>';
