        ...
        <div id="tab-local">
          <table class="form">
            <tr>
              ...
              <td><select name="config_paises_id" onchange="$('select[name=\'config_zone_id\']').load('index.php?route=setting/store/zone&token=<?php echo $token; ?>&paises_id=' + this.value + '&zone_id=<?php echo $config_zone_id; ?>');">
        ...
        <div id="tab-option">
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="config_cliente_group_id">
                  <?php foreach ($cliente_groups as $cliente_group) { ?>
                  <?php if ($cliente_group['cliente_group_id'] == $config_cliente_group_id) { ?>
            ...
            <tr>
              <td><?php echo $entry_cliente_price; ?></td>
              <td><?php if ($config_cliente_price) { ?>
                <input type="radio" name="config_cliente_price" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_cliente_price" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_cliente_price" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_cliente_price" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><?php echo $entry_cliente_approval; ?></td>
              <td><?php if ($config_cliente_approval) { ?>
                <input type="radio" name="config_cliente_approval" value="1" checked="checked" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_cliente_approval" value="0" />
                <?php echo $text_no; ?>
                <?php } else { ?>
                <input type="radio" name="config_cliente_approval" value="1" />
                <?php echo $text_yes; ?>
                <input type="radio" name="config_cliente_approval" value="0" checked="checked" />
                <?php echo $text_no; ?>
                <?php } ?></td>
            </tr>
            <tr>
...
$('select[name=\'config_zone_id\']').load('index.php?route=setting/store/zone&token=<?php echo $token; ?>&paises_id=<?php echo $config_paises_id; ?>&zone_id=<?php echo $config_zone_id; ?>');
//--></script> 
<script type="text/javascript"><!--
