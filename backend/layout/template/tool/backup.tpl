...
<div id="content">
  <div class="breadcrumb">
    ...
    <?php echo $breadcrumb['separator']; ?><a href="<?php echo $breadcrumb['layout/template/tool/href']; ?>"><?php echo $breadcrumb['text']; ?></a>
    <?php } ?>
  </div>
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="layout/image/backup.png" alt="" /> <?php echo $heading_title; ?></h1>
