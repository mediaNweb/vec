<?php
class ModelInscripcionesCorreos extends Model {	

	public function deleteCorreo($participante_id) {
		
		$inscripcion = $this->getInscripcionByCorreo($participante_id);
		$numero = $this->getNumeroByCorreo($participante_id);
		$evento_id = $this->getEventoByCorreo($participante_id);
	...
	public function editCorreo($participante_id, $data) {
	...
	public function getCorreosIdDatos($eventos_id, $order_id, $cliente_id) {
	...
	public function getCorreoComboByOpcion($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoCedula($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoApellido($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoNombre($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoGenero($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoFdn($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoEmail($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoCelular($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoPais($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoEstado($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoEdad($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoCategoria($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoGrupo($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoTiempo($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoTiempoX($order_id, $order_product_id, $id_evento) {
	...
	public function getCorreoNumero($cliente, $evento) {
	...
	public function getCedulaCorreo($cliente, $evento) {
	...
	public function getApellidoCorreo($cliente, $evento) {
	...
	public function getNombreCorreo($cliente, $evento) {
	...
	public function getGeneroCorreo($cliente, $evento) {
	...
	public function getFdnCorreo($cliente, $evento) {
	...
	public function getEmailCorreo($cliente, $evento) {
	...
	public function getCelularCorreo($cliente, $evento) {
	...
	public function getPaisCorreo($cliente, $evento) {
	...
	public function getEstadoCorreo($cliente, $evento) {
	...
	public function getEdadCorreo($cliente, $evento) {
	...
	public function getCategoriaCorreo($cliente, $evento) {
	...
	public function getGrupoCorreo($cliente, $evento) {
	...
	public function getTiempoCorreo($cliente, $evento) {
	...
	public function getNumeroCorreo($cliente, $evento) {
	...
	public function getCorreo($eventos_id) {
	...
	public function getDatosCorreo($participantes_id) {
...
//		$participante_query = $this->db->query("SELECT s.order_id AS Solicitud, s.payment_method AS Pago, s.payment_number AS Deposito, ep.eventos_participantes_numero AS Numero, ep.eventos_participantes_cedula AS Cedula, ep.eventos_participantes_apellidos AS Apellidos, ep.eventos_participantes_nombres AS Nombres, ep.eventos_participantes_genero AS Genero, ep.eventos_participantes_fdn AS Nacimiento, ep.eventos_participantes_email AS Email, ep.eventos_participantes_cel AS Celular, pai.paises_nombre AS Pais, est.estados_nombre AS Estado, ep.eventos_participantes_grupo AS Grupo, ep.eventos_participantes_edad AS Edad, ep.eventos_participantes_categoria AS Categoria, ep.eventos_participantes_datos FROM `" . DB_PREFIX . "eventos_participantes` ep LEFT JOIN `" . DB_PREFIX . "solicitud` s ON (ep.eventos_participantes_id_pedido = s.order_id) LEFT JOIN `" . DB_PREFIX . "paises` pai ON (ep.eventos_participantes_id_pais = pai.paises_id) LEFT JOIN `" . DB_PREFIX . "estados` est ON (ep.eventos_participantes_id_estado = est.estados_id) WHERE ep.eventos_participantes_id = '" . (int)$participantes_id . "'");
	...
	public function getRespuestaAcompañante($datos) {
		...
		$datos_query = $this->db->query("SELECT value FROM " . DB_PREFIX . "solicitud_opcion_21 WHERE order_product_id = '" . (int)$datos . "' AND name = 'Acompañante'");
	...
	public function getRespuestaTransporte($datos) {
		...
		$datos_query = $this->db->query("SELECT value FROM " . DB_PREFIX . "solicitud_opcion_21 WHERE order_product_id = '" . (int)$datos . "' AND name = 'Transporte'");
	...
	public function getRespuestaCiudad($datos) {
		...
		$datos_query = $this->db->query("SELECT value FROM " . DB_PREFIX . "solicitud_opcion_21 WHERE order_product_id = '" . (int)$datos . "' AND name = 'Ciudad'");
	...
	public function getOpcionesCorreosExport($datos, $eventos_id) {
...
//		$opciones_query = $this->db->query("SELECT so.name, so.value FROM `" . DB_PREFIX . "solicitud_opcion` so WHERE order_product_id = '" . (int)$datos . "' AND so.name IN (SELECT od.opcion_nombre FROM `" . DB_PREFIX . "opcion_descripcion` od)");
	...
	public function getOpcionesCorreosExportNEW($datos) {
	...
	public function confirm($cliente, $solicitud, $evento, $numero, $order_product_id) {
			...
			$confirmado = $this->isCorreoConfirmado($cliente, $evento);
			...
			if(!$confirmado) {
				...
				$apellido_part = $this->getCorreoApellido($solicitud, $order_product_id, $evento);
				$nombre_part = $this->getCorreoNombre($solicitud, $order_product_id, $evento);
				$grupo_part = $this->getCorreoGrupo($solicitud, $order_product_id, $evento);
				$categoria_part = $this->getCorreoCategoria($solicitud, $order_product_id, $evento);
				$email_part = $this->getCorreoEmail($solicitud, $order_product_id, $evento);
...
*/
	...
	public function updateXX($eventos_id, $participante_status_id, $comment = '', $notify = false) {
		$participante_info = $this->getCorreo($eventos_id);
...
*/
	...
	public function update($cliente, $solicitud, $evento, $numero, $order_product_id) {
		...
		$apellido_part = $this->getApellidoCorreo($cliente, $evento);
		$nombre_part = $this->getNombreCorreo($cliente, $evento);
		$grupo_part = $this->getGrupoCorreo($cliente, $evento);
		$categoria_part = $this->getCategoriaCorreo($cliente, $evento);
		$email_part = $this->getEmailCorreo($cliente, $evento);
...
*/				
	...
	public function isCorreo($clientes_id, $eventos_id) {
	...
	public function isCorreoConfirmado($clientes_id, $eventos_id) {
	...
	public function getTotalCorreosByEvento($eventos_id) {
	...
	public function getTotalCorreosConfirmadosByEvento($eventos_id) {
	...
	public function getTotalCorreosNoConfirmadosByEvento($eventos_id) {
...
//		$query = $this->db->query("SELECT COUNT(DISTINCT ep.eventos_participantes_id_cliente) as total FROM `" . DB_PREFIX . "eventos_participantes` ep LEFT JOIN solicitud s ON (ep.eventos_participantes_id_pedido = s.order_id) WHERE ep.eventos_participantes_id_evento  = '" . (int)$eventos_id . "' AND ep.eventos_participantes_numero = 0 AND ep.eventos_participantes_inscripcion = 'Internet' AND ep.eventos_participantes_id_pedido IN (SELECT order_id FROM solicitud WHERE (order_status_id = 0 OR order_status_id = 1 OR order_status_id = 2) AND payment_number <> '')");
	...
	public function getOpcionCorreoConsulta($order_product_id) {
	...
	public function getOpcionCorreoT($order_product_id, $eventos_id) {
...
//			for($i=0;$i<count($datos_evento);$i++)
	...
	public function getOpcionesCorreo($order_product_id, $id_evento) {
...
*/
	...
	public function getOpcionCorreo($order_product_id, $eventos_id) {
...
*/
	...
	public function getCorreosByEvento($eventos_id, $data = array()) {
...
*/
	...
	public function getTodosCorreos() {
...
//		$sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "eventos e LEFT JOIN " . DB_PREFIX . "eventos_descripcion ed ON (e.eventos_id = ed.eventos_descripcion_id_evento) WHERE eventos_status = 1";
		$sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "eventos e LEFT JOIN " . DB_PREFIX . "eventos_descripcion ed ON (e.eventos_id = ed.eventos_descripcion_id_evento)";
...
//			$sql = "SELECT * FROM " . DB_PREFIX . "eventos e LEFT JOIN " . DB_PREFIX . "eventos_descripcion ed ON (e.eventos_id  = ed.eventos_descripcion_id_evento) WHERE eventos_status = 1"; 
			$sql = "SELECT * FROM " . DB_PREFIX . "eventos e LEFT JOIN " . DB_PREFIX . "eventos_descripcion ed ON (e.eventos_id = ed.eventos_descripcion_id_evento)"; 
	...
	public function updateCedulaCorreo($id_participante, $dato) {
	...
	public function updateApellidosCorreo($id_participante, $dato) {
	...
	public function updateNombresCorreo($id_participante, $dato) {
	...
	public function updateGéneroCorreo($id_participante, $dato) {
	...
	public function updateFdNCorreo($id_participante, $dato) {
	...
	public function updateEmailCorreo($id_participante, $dato) {
	...
	public function updateCelCorreo($id_participante, $dato) {
	...
	public function updatePaisCorreo($id_participante, $dato) {
	...
	public function updateEstadoCorreo($id_participante, $dato) {
	...
	public function updateEdadCorreo($id_participante, $dato) {
	...
	public function updateCategoriaCorreo($id_participante, $dato) {
	...
	public function updateGrupoCorreo($id_participante, $dato) {
...
//		$query = $this->db->query("SELECT en.eventos_numeros_id_cliente, en.eventos_numeros_numero FROM `" . DB_PREFIX . "eventos_numeros` en WHERE en.eventos_numeros_id_evento = '" . (int)$evento_id . "' AND en.eventos_numeros_id_cliente <> '' AND eventos_numeros_id_cliente NOT IN (SELECT eventos_participantes_id_cliente FROM `" . DB_PREFIX . "eventos_participantes` WHERE eventos_participantes_id_evento = '" . (int)$evento_id . "' ) ORDER BY eventos_numeros_numero");
	...
	public function agregaCorreo($evento_id, $cedula, $data = array()) {

		$participante = $this->isCorreo($cedula, $evento_id);
	...
	public function getTotalCorreosSinConfirmarByEvento($evento_id) {
	...
	public function getCorreosSinConfirmarByEvento($evento_id) {
...
//		return $query->rows;
	...
	public function corrigeCorreos($solicitud, $evento_id, $datos, $participante_id) {
	...
	public function corregirNumeroCorreoND($evento_id, $cedula, $numero) {
	...
	public function getNumeroByCorreo($participante_id) {
	...
	public function getDatosCorreoND($cedula, $evento_id) {
	...
	public function getInscripcionByCorreo($participante_id) {
	...
	public function getEventoByCorreo($participante_id) {
