...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="layout/image/home.png" alt="" /> <?php echo $heading_title; ?></h1>
    </div>
    <div class="content">
      <div class="overview">
        ...
        <div class="dashboard-content">
          <table>
            ...
            <tr>
              <td><?php echo $text_total_cliente; ?></td>
              <td><?php echo $total_cliente; ?></td>
            </tr>
          </table>
        </div>
      </div>
          ...
          <table class="list">
            <thead>
              <tr>
                ...
                <td class="left"><?php echo $column_cliente; ?></td>
...
<!--[if IE]>
<script type="text/javascript" src="layout/javascript/jquery/flot/excanvas.js"></script>
<![endif]--> 
<script type="text/javascript" src="layout/javascript/jquery/flot/jquery.flot.js"></script> 
...
function getSalesChart(range) {
	$.ajax({
		...
		success: function(json) {
			...
			$.plot($('#report'), [json.order, json.cliente], option);
		}
	});
}
