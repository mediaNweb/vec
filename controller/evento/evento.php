...
//						$this->data['laps'] = ($vueltas != '') ? $vueltas : '-';
						...
						$this->data['general_ritmo'] = ($resultado_general['ritmo'] != '') ? $resultado_general['ritmo'] : '-';
//						$this->data['laps'] = ($vueltas != '') ? $vueltas : '-';
						...
						$this->data['genero_ritmo'] = ($resultado_genero['ritmo'] != '') ? $resultado_genero['ritmo'] : '-';
//						$this->data['laps'] = ($vueltas != '') ? $vueltas : '-';
						...
						$this->data['categoria_ritmo'] = ($resultado_categoria['ritmo'] != '') ? $resultado_categoria['ritmo'] : '-';
//						$this->data['laps'] = ($vueltas != '') ? $vueltas : '-';
