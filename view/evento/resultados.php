    ...
    <div class="row">
      <div class="col-lg-12"> 
        ...
        <div class="attention-box">
          ...
          <a href="<?php echo $instamagazine_url; ?>" target="_blank" class="more"><?php echo $text_result_instamagazine_link; ?></a> </div>
        <!--/ .attention-box --> 
        <!--/ END Attention Box --> 
      </div>
      <?php } ?>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-sm-offset-0 col-xs-8 col-xs-offset-2">
          <li class="price best-value" Xdata-sr="enter bottom over 1s and move 80px wait 0.2s">
            ...
            <ul class="price-feature">
              ...
              <li><?php echo $text_result_cell_gun; ?> <strong><?php echo $time_oficial; ?></strong></li>
            ...
            <!--/ .price-feature --> 
            <a href="#0" class="price-button all-caps"><?php echo $ritmo; ?> <?php echo $speed_unit; ?></a> </li>
          <!--/ .price --> 
        </div>
        <!--/ .col-lg-3 -->
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-sm-offset-0 col-xs-8 col-xs-offset-2">
          <li class="price" Xdata-sr="enter bottom over 1s and move 80px wait 0.3s">
            ...
            <ul class="price-feature">
              ...
              <li><?php echo $text_result_cell_gun; ?> <strong><?php echo $general_time_oficial; ?></strong></li>
            ...
            <!--/ .price-feature --> 
            <a href="#0" class="price-button all-caps"><?php echo $general_ritmo; ?> <?php echo $speed_unit; ?></a> </li>
          <!--/ .price --> 
        </div>
        <!--/ .col-lg-3 -->
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-sm-offset-0 col-xs-8 col-xs-offset-2">
          <li class="price" Xdata-sr="enter bottom over 1s and move 80px wait 0.4s">
            ...
            <ul class="price-feature">
              ...
              <li><?php echo $text_result_cell_gun; ?> <strong><?php echo $genero_time_oficial; ?></strong></li>
            ...
            <!--/ .price-feature --> 
            <a href="#0" class="price-button all-caps"><?php echo $genero_ritmo; ?> <?php echo $speed_unit; ?></a> </li>
          <!--/ .price --> 
        </div>
        <!--/ .col-lg-3 -->
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-sm-offset-0 col-xs-8 col-xs-offset-2">
          <li class="price" Xdata-sr="enter bottom over 1s and move 80px wait 0.5s">
            ...
            <ul class="price-feature">
              ...
              <li><?php echo $text_result_cell_gun; ?> <strong><?php echo $categoria_time_oficial; ?></strong></li>
            ...
            <!--/ .price-feature --> 
            <a href="#0" class="price-button all-caps"><?php echo $categoria_ritmo; ?> <?php echo $speed_unit; ?></a> </li>
          <!--/ .price --> 
        </div>
        <!--/ .col-lg-3 -->
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 centered">
            ...
            <div class="clearfix"></div>
            <small Xdata-sr="enter bottom over 1s and move 75px wait 0.2s"><a href="<?php echo $chronotrack; ?>" target="_blank"><?php echo $text_result_widget_link; ?></a></small> </div>
          <!--/ .col-lg-12 --> 
